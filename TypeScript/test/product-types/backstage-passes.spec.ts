...
import { GildedRose, Item } from "@/gilded-rose";
  ...
  describe('Backstage passes', () => {
    ...
    ])('should increase quality by 1 when sellIn is above 10', (item, expectedSellIn, expectedQuality) => {
    ...
    ]) ('should increase quality by 2 when sellIn is between 6 and 10', (item, expectedSellIn, expectedQuality) => {
      const gildedRose = new GildedRose([item]);
      gildedRose.updateQuality();
      expect(gildedRose.items[0].quality).toBe(expectedQuality);
      expect(gildedRose.items[0].sellIn).toBe(expectedSellIn);
    ...
    ])('should increase quality by 3 when sellIn is between 0 and 5', (item, expectedSellIn, expectedQuality) => {
      const gildedRose = new GildedRose([item]);
      gildedRose.updateQuality();
      expect(gildedRose.items[0].quality).toBe(expectedQuality);
      expect(gildedRose.items[0].sellIn).toBe(expectedSellIn);
    ...
    ])('should have quality equal to zero and decrease sellIn by 1 when sellIn is negative', (item, expectedSellIn, expectedQuality) => {
      const gildedRose = new GildedRose([item]);
      gildedRose.updateQuality();
      expect(gildedRose.items[0].quality).toBe(expectedQuality);
      expect(gildedRose.items[0].sellIn).toBe(expectedSellIn);
    ...
    ])('should not allow quality to exceed 50', (item, expectedSellIn, expectedQuality) => {
      const gildedRose = new GildedRose([item]);
      gildedRose.updateQuality();
      expect(gildedRose.items[0].quality).toBe(expectedQuality);
      expect(gildedRose.items[0].sellIn).toBe(expectedSellIn);
